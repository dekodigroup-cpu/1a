...
export function QuoteBanner() {
  ...
  return (
    <section
      ref={ref}
      className="grain relative flex h-[100svh] min-h-[560px] w-full items-center overflow-hidden bg-navy-deep px-6 sm:px-12 lg:items-start lg:px-24 lg:pt-[25vh]"
    >
      <Photo
        photo={PHOTOS.town}
        plain
      ...
      <div className="absolute inset-0 bg-[linear-gradient(100deg,rgba(5,9,16,0.85)_0%,rgba(5,9,16,0.25)_55%,rgba(5,9,16,0)_100%)]" />
      ...
      <blockquote className="reveal-scale relative z-20 max-w-xs font-arsenica text-xl leading-snug text-white sm:max-w-md sm:text-3xl lg:max-w-2xl lg:text-5xl lg:leading-tight">
        ...
        <footer className="mt-8 font-inter text-[9px] uppercase not-italic tracking-[0.3em] text-brass sm:text-[10px]">
