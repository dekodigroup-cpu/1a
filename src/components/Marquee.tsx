...
export function Marquee() {
  ...
  return (
    <div className="relative z-30 -mt-px overflow-hidden border-y border-white/[0.07] bg-ink">
      ...
      <div className="marquee-track flex w-max items-center py-3.5 sm:py-4">
        {items.map((item, i) => (
          <span key={`${item}-${i}`} className="flex shrink-0 items-center">
            ...
            <span className="mx-6 h-1 w-1 rotate-45 bg-brass/55 sm:mx-10" aria-hidden="true" />
          </span>
        ))}
      </div>
    </div>
